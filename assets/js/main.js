...
questions.forEach((question) => {
  question.addEventListener("click", () => {
    // Toggle class 'active' pada pertanyaan untuk efek collapse
    question.classList.toggle("active");

    // Ambil elemen ikon dalam pertanyaan
    const icon = question.querySelector("i");

    // Toggle class ikon untuk mengganti ikon saat collapse aktif atau tidak aktif
    ...
    // Ambil elemen jawaban yang berada di bawah pertanyaan
